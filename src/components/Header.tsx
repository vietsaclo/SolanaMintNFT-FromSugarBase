        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <a href="https://catai-home.pepemetaai.co/" className="nav-link">
                Home
              </a>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              <a href="https://catai-mindmap.pepemetaai.co/" className="nav-link">
                MindMap
              </a>
            </li>
            <li className="nav-item">
          ...
          <div className="d-flex align-items-center ms-4">
            <div className=""><WalletMultiButton /></div>
          </div>
        </div>
      </div>
    </nav>
